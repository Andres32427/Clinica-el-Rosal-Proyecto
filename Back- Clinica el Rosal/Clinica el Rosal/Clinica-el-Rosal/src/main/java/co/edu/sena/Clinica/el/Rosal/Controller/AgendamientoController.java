...
public class AgendamientoController {
    ...
    // Este Controlador cuenta con la funcion de obtener todos los agendamientos por parte de los medicos
    @GetMapping("/auxiliar")
    @PreAuthorize("hasRole('AUXILIAR')")
    public ResponseEntity<List<AgendamientoEntity>> verTodosLosAgendamientos(){
        return ResponseEntity.ok(service.obtenerTodosLosAgendamientos());
    }
